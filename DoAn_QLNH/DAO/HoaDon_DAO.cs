...
namespace DAO
{
    public class HoaDon_DAO
    {
        ...
        public static bool XoaToanBoHoaDon()
        {
            ...
            string chuoiTruyVan1 = string.Format("Delete from HoaDonInFo");
            string chuoiTruyVan2 = string.Format("Delete from HoaDon");
            conn = DataProvider.MoKetNoi();
            try
            {
                DataProvider.ThucThiTruyVanNonQuery(chuoiTruyVan1, conn);
                DataProvider.ThucThiTruyVanNonQuery(chuoiTruyVan2, conn);
                DataProvider.DongKetNoi(conn);
                return true;
            }
            catch (Exception)
